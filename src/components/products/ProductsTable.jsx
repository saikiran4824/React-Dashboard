...
const ProductsTable = () => {
  ...
  const [editedProduct, setEditedProduct] = useState(null); // Track edited values
  ...
  // Handle the Cancel action after editing
  const handleCancel = () => {
    setEditingProduct(null);
    setEditedProduct(null);
  };

  // Handle the Trash action
                ...
                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-300">
                  {editingProduct === product.id ? (
                    <input
                      ...
                      onChange={(e) =>
                        setEditedProduct({ ...editedProduct, stock: parseInt(e.target.value, 10) })
                      }
                      className="bg-gray-700 text-white rounded-md p-1"
                    />
                  ) : (
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                  {editingProduct === product.id ? (
                    <input
                      ...
                      onChange={(e) =>
                        setEditedProduct({ ...editedProduct, sales: parseInt(e.target.value, 10) })
                      }
                      className="bg-gray-700 text-white rounded-md p-1"
                    />
                  ) : (
